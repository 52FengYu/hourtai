...
(function () {
  ...
  (function () {
    ...
    baidu.lang.guid = function () {
      return "TANGRAM__" + (window[baidu.guid]._counter++).toString();
    };
     ...
     * @meta standard
     * @remark 引入该模块，会自动为Class引入个事件扩展方法：addEventListener、removeEventListener和dispatchEvent。
     ...
     * @param {baidu.lang.Event|String} event  Event对象，或事件名称(..起支持)
     * @param {Object} options 扩展参数,所含属性键值会扩展到Event对象上(.起支持)
    ...
    baidu.insertHTML = baidu.dom.insertHTML = function (element, position, html) {
      ...
      if (element.insertAdjacentHTML) {
        ...
        // 改用range.insertNode来插入html, by wenyuxiang @ --.
     ...
     * @remark
     * 使用者应保证提供的className合法性，不应包含不合法字符，className合法字符参考：http://www.w.org/TR/CSS/syndata.html。
     * @shortcut addClass
     * @meta standard
     *
     * @returns {HTMLElement} 目标元素
     ...
     * @remark
     *  . 不支持跨浏览器的鼠标滚轮事件监听器添加<br>
     *  . 改方法不为监听器灌入事件对象，以防止跨iframe事件挂载的事件对象获取失败
     * @shortcut on
     * @meta standard
     * @see baidu.event.un
     *
    ...
    baidu.on = baidu.event.on = function (element, type, listener) {
      ...
      var realListener = function (ev) {
          // . 这里不支持EventArgument,  原因是跨frame的事件挂载
          // . element是为了修正this
  ...
  var DrawingManager =
     ...
     * <br />      "<b>scale</b>" : {Number} 工具栏的缩放比例,默认为
     ...
     * <br />"<b>markerOptions</b>" : {CircleOptions} 所画的点的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E%%BB%E%B%BB/%E%A%%E%B%%E%%A%E%B%BB">对应类</a>
     * <br />"<b>circleOptions</b>" : {CircleOptions} 所画的圆的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E%%BB%E%B%BB/%E%A%%E%B%%E%%A%E%B%BB">对应类</a>
     * <br />"<b>polylineOptions</b>" : {CircleOptions} 所画的线的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E%%BB%E%B%BB/%E%A%%E%B%%E%%A%E%B%BB">对应类</a>
     * <br />"<b>polygonOptions</b>" : {PolygonOptions} 所画的多边形的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E%%BB%E%B%BB/%E%A%%E%B%%E%%A%E%B%BB">对应类</a>
     * <br />"<b>rectangleOptions</b>" : {PolygonOptions} 所画的矩形的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E%%BB%E%B%BB/%E%A%%E%B%%E%%A%E%B%BB">对应类</a>
     *
     * @example <b>参考示例：</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(., .), );<br />
  ...
  /**
   * 设置当前的绘制模式，参数DrawingType，为个可选常量:
  ...
  DrawingManager.prototype._addGeoUtilsLibrary = function () {
    if (!BMapLib.GeoUtils) {
      ...
      script.setAttribute("src", 'http://api.map.baidu.com/library/GeoUtils/./src/GeoUtils_min.js');
  ...
  DrawingTool.prototype._generalHtml = function (map) {
    ...
    var getItem = function (className, drawingType) {
      return '<a class="' + className + '" drawingType="' + drawingType + '" href="javascript:void()" title="' + tips[drawingType] + '" οnfοcus="this.blur()"></a>';
    }
