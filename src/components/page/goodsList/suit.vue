        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
             ...
             <div class="clearfix-body">
                 ...
                 <div class="select">
                    <span>选择单品</span>
                    <el-button type="primary" @click="handleEdit">选择单品</el-button>
                 </div>
                 <div class="info">
                    <span>定价信息</span>
                    <el-table :data="form" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="price" label="销售单价" width="120" align="center"></el-table-column>
                        <el-table-column prop="num" label="套装内数量" width="150" align="center"></el-table-column>
                        <el-table-column prop="count" label="单价合计" width="120" align="center"></el-table-column>
                        <el-table-column prop="inPrice" label="套餐内价格" width="150" align="center"></el-table-column>
                        <el-table-column prop="newPrice" label="新套装价" width="120" align="center"></el-table-column>
                        <el-table-column prop="inventory" label="套装库存" width="150" align="center"></el-table-column>
                        <el-table-column prop="pricing" label="起订价" width="120" align="center"></el-table-column>
                        <el-table-column prop="max" label="最大限购量" width="120" align="center"></el-table-column>
                    </el-table>
                 </div>
                 ...
                 <el-button type="success">发布套装</el-button>
            </div>
            
        </el-card>
        <!-- 编辑弹出框 -->
        <el-dialog title="选择商品" :visible.sync="editVisible" width="96%">
            <div class="top">
                <!-- 选择店铺名称 -->
