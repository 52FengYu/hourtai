            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column label="操作" align="center" fixed="right" min-width="150">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" icon="el-icon-edit">修改栏目</el-button>
                        <el-button type="primary" icon="el-icon-edit">上移</el-button>
                        <el-button type="primary" icon="el-icon-edit">下移</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
